...
async function main() {
  ...
  await prisma.figurinhas.createMany({
    data: [
      ...
      { id_figurinha: 3, nome: "Convento Franciscano e Museu Pinacoteca", descricao: "Igreja", valor_figurinha: 100 },
      { id_figurinha: 4, nome: "Sobrado do Imperador", descricao: "Museu", valor_figurinha: 100 },
      { id_figurinha: 5, nome: "Biblioteca Municipal", descricao: "Outros", valor_figurinha: 100 },
      { id_figurinha: 6, nome: "Museu Histórico de Igarassu", descricao: "Museu", valor_figurinha: 100 },
      { id_figurinha: 7, nome: "Casa do Artesão", descricao: "Outros", valor_figurinha: 100 },
    ],
    skipDuplicates: true
  });
  ...
  await prisma.pontos_turisticos.createMany({
    data: [
      ...
      { id_ponto: 4, 
        ...
        preco_entrada: 0.0, tipo: "Hist_rico", 
        id_figurinha: 1, 
        id_endereco: 4 
      },
      { id_ponto: 5, 
